...
const HomePage = ()=>{
 ...
 return(<main className={styles.main}>
          ...
          <div className="flex flex-wrap gap-4 items-center" style={{alignItems:"center"}}>
            ...
            onChange={e=>{setSelect(e.target.value); setVerificador("seleccionado")}}>
              <SelectItem key={"licenciatura"}>LICENCIATURA</SelectItem>
              <SelectItem key={"posgrado"}>POSGRADO</SelectItem>
            </Select>
            {select==""?"":count===404?<p><i>Has excedido el limite de consultas. Recarga la pagina dentro de 20 mins</i></p>
